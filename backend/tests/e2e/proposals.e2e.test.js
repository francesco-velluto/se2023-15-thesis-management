...
describe("End to end test for update proposal", () => {
    ...
    test("Shouldn't update the proposal if cancel the action", async() =>{
        ...
        const htmlBefore = await driver.findElement(By.css('html')).getAttribute('innerHTML');
        ...
        const showDetailsButton = await firstProposal.findElement(By.css('#proposal-detail-actions-showdetails'));

        await showDetailsButton.click();

        await driver.sleep(500);

        const htmlAfter = await driver.findElement(By.css('html')).getAttribute('innerHTML');
