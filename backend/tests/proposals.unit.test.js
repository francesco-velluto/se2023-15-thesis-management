...
const { getMaxProposalIdNumber, insertProposal } = require('../service/proposals.service'); // Import your database functions
...
describe("T2 - Insert proposals unit tests", () => {
    test.skip("T2.1 - ERROR 401 | Unauthorized", () => {
        ...
        proposalsController.insertProposal(req, res);
