...
/**
 * This file contains the implementation of the email notifier.
 */
...
module.exports = {
    sendEmailNotification: (notificationId, destination, subject, htmlContent) => {
        return new Promise((resolve, reject) => {
            ...
            console.info("[EMAIL-NOTIFIER]: Sending email notification with id " + notificationId + " to " + destination);
            transporter.sendMail(mailOptions, (err, info) => {
                if (err) {
                    ...
                    console.info("[EMAIL-NOTIFIER]: Email notification with id " + notificationId + " sent to " + destination + " successfully");
                    resolve(info);
                }
            });
        });
