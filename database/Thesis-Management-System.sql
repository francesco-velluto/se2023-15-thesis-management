...
INSERT INTO public.proposals (proposal_id, title, supervisor_id, keywords, type, groups, description, required_knowledge, notes, expiration_date, level, programmes) VALUES
  ('P001', 'Web Development', 'T001', ARRAY['Web', 'Development'], 'Theoretical', ARRAY['Group A'], 'A web development project description.', 'HTML, CSS, JavaScript', 'No special notes.', '2023-12-31', 'Bachelor', ARRAY['BSC001']),
  ('P002', 'Machine Learning', 'T002', ARRAY['Machine Learning', 'AI'], 'Research', ARRAY['Group B'], 'A machine learning thesis description.', 'Python, TensorFlow', 'N/A', '2024-06-30', 'Master', ARRAY['MSC001', 'MSC002']),
  ('P003', 'Artificial Intelligence', 'T003', ARRAY['AI', 'Machine Learning'], 'Experimental', ARRAY['Group A'], 'An AI research thesis description.', 'Python, TensorFlow', 'N/A', '2024-05-15', 'Master', ARRAY['MSC001']),
  ('P004', 'Environmental Impact Analysis', 'T004', ARRAY['Environmental Science', 'Experimental'], 'Research', ARRAY['Group B'], 'An environmental impact analysis thesis description.', 'Environmental Science knowledge', 'N/A', '2023-11-30', 'Master', ARRAY['MSC001']),
  ('P005', 'Marketing Strategies', 'T005', ARRAY['Marketing', 'Strategies'], 'Theoretical', ARRAY['Group C'], 'A marketing strategies thesis description.', 'Marketing fundamentals', 'N/A', '2023-10-20', 'Bachelor', ARRAY['BSC001']),
  ('P006', 'Robotics and Automation', 'T006', ARRAY['Robotics', 'Automation'], 'Research', ARRAY['Group A'], 'A robotics and automation thesis description.', 'Robotics knowledge', 'N/A', '2024-02-28', 'Master', ARRAY['MSC003']),
  ...
  ('P016', 'Neural Networks', 'T003', ARRAY['Neural Networks', 'Deep Learning'], 'Research', ARRAY['Group B'], 'A thesis on neural networks and deep learning.', 'Python, TensorFlow, Keras', 'N/A', '2023-11-25', 'Bachelor', ARRAY['BSC001']),
  ('P017', 'Digital Marketing', 'T001', ARRAY['Digital Marketing', 'Social Media'], 'Theoretical', ARRAY['Group C'], 'A thesis on digital marketing strategies.', 'Marketing, Social Media', 'N/A', '2024-04-30', 'Bachelor', ARRAY['BSC001']),
  ('P018', 'Cybersecurity', 'T002', ARRAY['Cybersecurity', 'Network Security'], 'Research', ARRAY['Group A'], 'A thesis on cybersecurity and network security.', 'Cybersecurity, Encryption', 'N/A', '2023-10-15', 'Bachelor', ARRAY['BSC001']),
  ('P019', 'Bioinformatics', 'T003', ARRAY['Bioinformatics', 'Computational Biology'], 'Research', ARRAY['Group B'], 'A bioinformatics research thesis description.', 'Python, Biology, Genetics', 'N/A', '2024-05-20', 'Bachelor', ARRAY['BSC001']),
  ('P020', 'Project Management', 'T001', ARRAY['Project Management', 'Agile'], 'Theoretical', ARRAY['Group D'], 'A thesis on project management methodologies.', 'Agile, Scrum', 'N/A', '2023-09-15', 'Bachelor', ARRAY['BSC001']),
  ('P021', 'Database Design', 'T002', ARRAY['Database Design', 'SQL'], 'Theoretical', ARRAY['Group A'], 'A thesis on database design and SQL.', 'Database Management, SQL', 'N/A', '2024-06-15', 'Bachelor', ARRAY['BSC001']),
  ('P022', 'Renewable Energy', 'T003', ARRAY['Renewable Energy', 'Sustainability'], 'Research', ARRAY['Group B'], 'A thesis on renewable energy and sustainability.', 'Environmental Science, Renewable Energy', 'N/A', '2024-02-10', 'Bachelor', ARRAY['BSC001']),
  ('P023', 'E-commerce Strategies', 'T001', ARRAY['E-commerce', 'Strategies'], 'Theoretical', ARRAY['Group C'], 'A thesis on e-commerce strategies and online business.', 'E-commerce, Marketing', 'N/A', '2023-11-05', 'Bachelor', ARRAY['BSC001']),
  ('P024', 'Natural Language Processing', 'T002', ARRAY['NLP', 'Language Processing'], 'Research', ARRAY['Group A'], 'A thesis on natural language processing and language analysis.', 'Python, NLP', 'N/A', '2024-03-20', 'Bachelor', ARRAY['BSC001']),
  ('P025', 'Global Marketing Trends', 'T003', ARRAY['Global Marketing', 'Trends'], 'Theoretical', ARRAY['Group D'], 'A thesis on global marketing trends and consumer behavior.', 'Marketing, Consumer Behavior', 'N/A', '2023-10-30', 'Bachelor', ARRAY['BSC001']);
