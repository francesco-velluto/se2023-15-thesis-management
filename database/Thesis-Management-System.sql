...
INSERT INTO public.proposals (proposal_id, title, supervisor_id, keywords, type, groups, description, required_knowledge, notes, expiration_date, level, programmes, archived) VALUES
  ...
  ('P018', 'Cybersecurity', 'T002', ARRAY['Cybersecurity', 'Network Security'], 'Research', ARRAY['Group A'], 'A thesis on cybersecurity and network security.', 'Cybersecurity, Encryption', 'N/A', '2024-10-15', 'Bachelor', ARRAY['BSC001'], false),
