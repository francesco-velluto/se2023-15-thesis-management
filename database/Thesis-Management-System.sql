...
INSERT INTO public.proposals (proposal_id, title, supervisor_id, keywords, type, groups, description, required_knowledge, notes, expiration_date, level, programmes, archived) VALUES
  ('P001', 'Web Development', 'T001', ARRAY['Web', 'Development'], 'Theoretical', ARRAY['G001'], 'A web development project description.', 'HTML, CSS, JavaScript', 'No special notes.', '2023-12-31', 'Bachelor', ARRAY['BSC001'], false),
  ('P002', 'Machine Learning', 'T002', ARRAY['Machine Learning', 'AI'], 'Research', ARRAY['G002'], 'A machine learning thesis description.', 'Python, TensorFlow', 'N/A', '2024-06-30', 'Master', ARRAY['MSC001', 'MSC002'], false),
  ('P003', 'Artificial Intelligence', 'T003', ARRAY['AI', 'Machine Learning'], 'Experimental', ARRAY['G001'], 'An AI research thesis description.', 'Python, TensorFlow', 'N/A', '2024-05-15', 'Master', ARRAY['MSC001'], false),
  ('P004', 'Environmental Impact Analysis', 'T004', ARRAY['Environmental Science', 'Experimental'], 'Research', ARRAY['G002'], 'An environmental impact analysis thesis description.', 'Environmental Science knowledge', 'N/A', '2023-11-30', 'Master', ARRAY['MSC001'], false),
  ('P005', 'Marketing Strategies', 'T005', ARRAY['Marketing', 'Strategies'], 'Theoretical', ARRAY['G003'], 'A marketing strategies thesis description.', 'Marketing fundamentals', 'N/A', '2023-10-20', 'Bachelor', ARRAY['BSC001'], false),
  ('P006', 'Robotics and Automation', 'T006', ARRAY['Robotics', 'Automation'], 'Research', ARRAY['G001'], 'A robotics and automation thesis description.', 'Robotics knowledge', 'N/A', '2024-02-28', 'Master', ARRAY['MSC003'], false),
  ('P007', 'Climate Change Impact', 'T007', ARRAY['Climate Change', 'Impact'], 'Experimental', ARRAY['G002'], 'A thesis on climate change impact analysis.', 'Environmental Science knowledge', 'N/A', '2024-03-15', 'Master', ARRAY['MSC002'], false),
  ('P008', 'Literary Analysis', 'T008', ARRAY['Literature', 'Analysis'], 'Theoretical', ARRAY['G004'], 'A literary analysis thesis description.', 'Literary analysis skills', 'N/A', '2023-11-10', 'Master', ARRAY['MSC001'], false),
  ('P009', 'Financial Risk Management', 'T009', ARRAY['Financial', 'Risk Management'], 'Theoretical', ARRAY['G003'], 'A thesis on financial risk management.', 'Finance knowledge', 'N/A', '2024-04-10', 'Master', ARRAY['MSC002'], false),
  ('P010', 'Introduction to Machine Learning', 'T010', ARRAY['Machine Learning', 'AI'], 'Research', ARRAY['G001'], 'An introductory thesis on machine learning.', 'Basic AI knowledge', 'N/A', '2023-09-30', 'Bachelor', ARRAY['BSC001'], false),
  ('P011', 'Software Engineering', 'T001', ARRAY['Software Engineering', 'Development'], 'Theoretical', ARRAY['G001'], 'A software engineering project description.', 'Java, Python, Git', 'N/A', '2023-08-25', 'Bachelor', ARRAY['BSC001'], false),
  ('P012', 'Data Analysis', 'T002', ARRAY['Data Analysis', 'Statistics'], 'Research', ARRAY['G002'], 'A data analysis thesis description.', 'R, Python, Statistics', 'N/A', '2024-01-15', 'Master', ARRAY['MSC001', 'MSC002'], false),
  ('P013', 'Human-Computer Interaction', 'T003', ARRAY['HCI', 'User Experience'], 'Experimental', ARRAY['G001'], 'A thesis on human-computer interaction.', 'UI/UX design, Psychology', 'N/A', '2023-12-10', 'Master', ARRAY['MSC001'], false),
  ('P014', 'Supply Chain Management', 'T001', ARRAY['Supply Chain', 'Management'], 'Theoretical', ARRAY['G003'], 'A thesis on supply chain management.', 'Logistics, Operations', 'N/A', '2024-03-05', 'Master', ARRAY['MSC001'], false),
  ('P015', 'Mobile App Development', 'T002', ARRAY['Mobile App', 'Development'], 'Research', ARRAY['G001'], 'A mobile app development project description.', 'Swift, Kotlin, React Native', 'N/A', '2024-02-20', 'Bachelor', ARRAY['BSC001'], false),
  ('P016', 'Neural Networks', 'T003', ARRAY['Neural Networks', 'Deep Learning'], 'Research', ARRAY['G002'], 'A thesis on neural networks and deep learning.', 'Python, TensorFlow, Keras', 'N/A', '2023-11-25', 'Bachelor', ARRAY['BSC001'], false),
  ('P017', 'Digital Marketing', 'T001', ARRAY['Digital Marketing', 'Social Media'], 'Theoretical', ARRAY['G003'], 'A thesis on digital marketing strategies.', 'Marketing, Social Media', 'N/A', '2024-04-30', 'Bachelor', ARRAY['BSC001'], false),
  ('P018', 'Cybersecurity', 'T002', ARRAY['Cybersecurity', 'Network Security'], 'Research', ARRAY['G001'], 'A thesis on cybersecurity and network security.', 'Cybersecurity, Encryption', 'N/A', '2024-10-15', 'Bachelor', ARRAY['BSC001'], false),
  ('P019', 'Bioinformatics', 'T003', ARRAY['Bioinformatics', 'Computational Biology'], 'Research', ARRAY['G002'], 'A bioinformatics research thesis description.', 'Python, Biology, Genetics', 'N/A', '2024-05-20', 'Bachelor', ARRAY['BSC001'], false),
  ('P020', 'Project Management', 'T001', ARRAY['Project Management', 'Agile'], 'Theoretical', ARRAY['G004'], 'A thesis on project management methodologies.', 'Agile, Scrum', 'N/A', '2023-09-15', 'Bachelor', ARRAY['BSC001'], false),
  ('P021', 'Database Design', 'T002', ARRAY['Database Design', 'SQL'], 'Theoretical', ARRAY['G001'], 'A thesis on database design and SQL.', 'Database Management, SQL', 'N/A', '2024-06-15', 'Bachelor', ARRAY['BSC001'], false),
  ('P022', 'Renewable Energy', 'T003', ARRAY['Renewable Energy', 'Sustainability'], 'Research', ARRAY['G002'], 'A thesis on renewable energy and sustainability.', 'Environmental Science, Renewable Energy', 'N/A', '2024-02-10', 'Bachelor', ARRAY['BSC001'], false),
