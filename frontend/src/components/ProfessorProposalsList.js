...
function ProposalRow({ proposal }) {
    ...
    return (
        <Row className='my-4 mx-2 border border-2 rounded border-dark bg-light p-3 my-md-1' >
            ...
            <Col xs={12} md={1} className="d-flex flex-row justify-content-center mt-3 mt-md-0" style={{ marginTop: '-2px', cursor: 'pointer', color: '#393646', fontWeight: "bold" }} onClick={() => { navigate('/proposals/' + proposal.proposal_id + '/update') }}>
                <span className="d-flex align-items-center">
                    <FaPen className="me-1" />
                    Update
                </span>
            </Col>
            <Col xs={12} md={1} className="d-flex flex-row justify-content-center mt-3 mt-md-0" style={{ marginTop: '-2px', cursor: 'pointer', color: '#393646', fontWeight: "bold" }} onClick={() => { navigate('/proposals/' + proposal.proposal_id) }}>
                <span className="d-flex align-items-center">
